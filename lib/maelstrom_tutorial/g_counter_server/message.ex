defmodule MaelstromTutorial.GCounterServer.Message do
  require Logger
  ...
  @doc ~S"""
    ...
    ## Examples
        ...
        iex> %MaelstromTutorial.GCounterServer.Message{src: "c0", dest: "n1", body: %MaelstromTutorial.GCounterServer.Message.Body.Error{type: "error", in_reply_to: 2, code: 42, text: "dunno"}} = MaelstromTutorial.GCounterServer.Message.decode(iodata)
        iex> iodata == MaelstromTutorial.GCounterServer.Message.encode(MaelstromTutorial.GCounterServer.Message.decode(iodata))
        true
  ...
  @doc ~S"""
    ...
    ## Examples
        ...
        iex> msg = %MaelstromTutorial.GCounterServer.Message{src: "c0", dest: "n1", body: %MaelstromTutorial.GCounterServer.Message.Body.Error{type: "error", in_reply_to: 2, code: 42, text: "dunno"}}
        iex> ~s({"src":"c0","dest":"n1","body":{"type":"error","text":"dunno","in_reply_to":2,"code":42}}) = MaelstromTutorial.GCounterServer.Message.encode(msg)
        iex> msg == MaelstromTutorial.GCounterServer.Message.decode(MaelstromTutorial.GCounterServer.Message.encode(msg))
        true
        iex> msg = %MaelstromTutorial.GCounterServer.Message{src: "c0", dest: "n1", body: %MaelstromTutorial.GCounterServer.Message.Body.Broadcast{type: "broadcast", message: 22, msg_id: 555}}
        iex> ~s({"src":"c0","dest":"n1","body":{"type":"broadcast","msg_id":555,"message":22}}) = MaelstromTutorial.GCounterServer.Message.encode(msg)
        iex> msg == MaelstromTutorial.GCounterServer.Message.decode(MaelstromTutorial.GCounterServer.Message.encode(msg))
        true
  ...
  defmodule Body do
    ...
    defmodule ReadOk do
      ...
      @spec new(integer(), Types.msg_id_t()) :: t()
    ...
    defmodule Replicate do
      ...
      @spec new(list(any())) :: t()
      def new(counters) do
        %__MODULE__{type: "replicate", counters: counters, msg_id: 0}
      end
    end
